      ...
      >
        ...
        <DialogContent>
          ...
          <TextField
              ...
              type="date"
              fullWidth
              value={salseFilter.startDate}
              onChange={(e) => setSalseFilter({ ...salseFilter, startDate: e.target.value })}
          />
          <TextField
              margin="dense"
              id="endDate"
              ...
              type="date"
              fullWidth
              value={salseFilter.endDate}
              onChange={(e) => setSalseFilter({ ...salseFilter, endDate: e.target.value })}
          />
        </div>
        </DialogContent>
          <DialogActions>
